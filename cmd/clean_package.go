...
var cleanPackageCmd = &cobra.Command{
	Use:     "package",
	Short:   "Remove .zip artifacts",
	Long:    "Reads dynamic-node-cli.yaml, locates the output directory for the given procedure, and removes .zip artifacts.",
	Example: "  dynamic-node clean package -c ./dynamic-node-cli.yaml -p my-app\n",
	Args:    cobra.NoArgs,
