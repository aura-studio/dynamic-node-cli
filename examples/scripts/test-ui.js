...
const STEPS = [
  ...
  },
  {
    ...
    name: "14 元数据测试",
    category: "验证",
    desc: "对所有已构建的 target package (bundle, full, servicebundle, servicefull, wirebundle, wirefull) 分别验证 meta read 和 meta call 输出含正确的 variant 信息。\n\n另外对 bundle/full zip 验证 meta nm（列出 zip 条目）和 meta objdump（JSON 清单）。",
    needsS3: false,
    needsBuild: true,
    isSuite: false,
  },
